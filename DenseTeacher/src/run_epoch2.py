...
from model import SSD300, SSD300_3Way, MultiBoxLoss, QualityFocalLoss
...
def softTeaching_every_batch(s_model: SSD300,
                             ...
                             criterion_DPL: QualityFocalLoss,
    ...
    for (batch_idx, (wL_image_vis, wL_image_lwir, sL_image_vis, sL_image_lwir, L_boxes, L_labels, L_is_anno)), \
        ...
        with torch.no_grad():
            ...
            # inference
            teacher_locs, teacher_scores, teacher_features = t_model(w_image_vis, w_image_lwir)  # (N, 8732, 4), (N, 8732, n_classes)
        ...
        # Forward prop.
        student_locs, student_scores, student_features = s_model(s_image_vis, s_image_lwir)  # (N, 8732, 4), (N, 8732, n_classes)
        L_features, student_U_features = split_features(student_features, len(L_boxes))
        ...
        un_DPL_loss = criterion_DPL(student_U_features, teacher_features)

        # Now compute the losses
        loss = sup_box_loss + 4 * (un_box_loss + un_DPL_loss)
